...
module.exports.login = function (email, pass) {
...
module.exports.getUsuarioByEmail = function (email) {
...
module.exports.getUsuarioByName = function (name) {
...
module.exports.addMatch = function (user, user2, msg) {
...
module.exports.addChat = function (author, user2, msg) {
...
module.exports.getChat = function (user, user2) {
    var usr = __getUsuarioByName(user);
